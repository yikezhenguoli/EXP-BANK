...
(() => {
  ...
  class ImageSlot extends HTMLElement {
    ...
    _enterReframe() {
      ...
      const ebOn = this._ctl && this._ctl.querySelector('[data-act="edit"]');
      if (ebOn) { ebOn.textContent = '✓ 完成'; ebOn.style.background = '#4ade80'; ebOn.style.color = '#0a0b0e'; ebOn.style.fontWeight = '700'; }
    ...
    _exitReframe(commit) {
      ...
      const ebOff = this._ctl && this._ctl.querySelector('[data-act="edit"]');
      if (ebOff) { ebOff.textContent = 'Edit'; ebOff.style.background = ''; ebOff.style.color = ''; ebOff.style.fontWeight = ''; }
      this.removeAttribute('data-panning');
